...
1. Установите {% include abbr/kefir_git.txt %}
...
Теперь можно установите {% include abbr/kefir_addr.txt %} ещё раз. Последующие запуски kefir будет запускаться автоматически сразу при включении приставки.
{: .notice--info}
