...
Внимание! В данный момент последняя версию системного ПО, 11.0.0, работает не так хорошо, как 10.2.0! Если ваш EmuNAND на версии ниже, чем 10.2.0, просто обновите его по инструкции ниже, если у вас в EmuNAND уже версия 11.0.0, пусть так и остаётся. SysNAND можете обновлять через настройки до 11.0.0. НИКОГДА не обновляйте SysNAND через ChoiDujourNX
{: .notice--warning}
