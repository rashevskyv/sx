...
1. Установите {% include abbr/kefir_git.txt %}, выбрав "**Atmosphere**" в качестве опции (`atmo.zip` для ручной установки)
...
1. Вставьте карту памяти приставки в ПК 
1. Установите {% include abbr/kefir_git.txt %}, выбрав "**Atmosphere for SX Core / Light**" в качестве опции (`modcip.zip` для ручной установки)
1. Дождитесь окончания установки, затем верните карту памяти в консоль
1. Включите консоль 
